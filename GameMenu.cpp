...
void Qna::PrintMenu()
{
	...
	while (1)
	{
		...
		if (nCount == 1)
		{
			...
			cout << "\t\t" << "                              6. 플레이 도중에 게임을 종료 하고 싶으시면 Enter를 눌러 나갈 수 있습니다." << endl << endl;
			cout << "\t\t" << "                              7. 블록을 바닥에 일렬로 완전히 두게 되면 사라지고 점수를 1000점을 얻습니다." << endl << endl;
			cout << "\t\t" << "                              8. 블록이 상단 일정 부분에 도달하게 되면 게임오버 입니다." << endl << endl;
			cout << "\t\t" << "                              9. 게임이 끝난 후 이름을 입력하여 랭킹에 점수를 올릴 수 있습니다!!" << endl << endl;
